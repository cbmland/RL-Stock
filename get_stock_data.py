...
class Downloader(object):
    ...
    def run(self):
        ...
        for index, row in stock_df.iterrows():
            ...
            df_code.to_csv(f'{self.output_dir}/{row["code"]}.{row["code_name"].replace("*","_")}.csv', index=False)
        self.exit()
...
if __name__ == '__main__':
    ...
    downloader = Downloader('./stockdata/test', date_start='2019-12-01', date_end='2020-05-29')
    downloader.run()
